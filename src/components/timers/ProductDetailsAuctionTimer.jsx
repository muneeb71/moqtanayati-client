...
const ProductDetailsAuctionTimer = ({ type = "" }) => {
  ...
  return (
    <div className="flex flex-col gap-3">
      <span
        className={cn(
          "text-[14.4px] font-medium leading-[21px] text-[#484848]",
        )}
      >
        Auction Ending In
      </span>
      <div className="flex items-center gap-2">
        <div className="flex flex-col items-center gap-1">
          <div
            className={cn(
              "grid size-[45.6px] place-items-center rounded-[6px] bg-moonstone/20 font-semibold text-moonstone",
            )}
          >
            {formatTime(hours)}
          </div>
