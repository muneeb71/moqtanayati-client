  ...
  return (
    <div className="flex w-full items-center justify-center gap-2 border-b-[1.5px] border-[#F0F1F4] pb-5 md:gap-[18px]">
      {orderCategories.map((orderCategory, index) => (
        ...
        key={index}
        className={cn(
          "flex items-center justify-center rounded-[12px] border-[1.5px] px-3 py-1.5 text-xs sm:text-sm md:px-5 md:py-2.5 md:text-base whitespace-nowrap",
