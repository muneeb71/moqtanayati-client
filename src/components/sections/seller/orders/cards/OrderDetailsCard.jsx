  ...
  return (
    <div className="flex w-full flex-col gap-4">
      {orderItems.length > 0 ? (
            ...
            >
              ...
              <div className="flex w-full items-center justify-between">
                <div className="flex flex-col gap-4">
                  ...
                  <span
                    className={`w-fit rounded-xl px-5 py-2 text-xl font-medium ${paid ? "bg-shamrockGreen/10 text-shamrockGreen" : "bg-orange-100 text-orange-600"}`}
                  >
                    {paid
                      ? t("seller.orders.details_card.paid")
                      : order.paymentStatus}
                  </span>
                </div>
        ...
        <div className="text-center text-battleShipGray">
          {t("seller.orders.details_card.no_items")}
        </div>
      )}
    </div>
  );
