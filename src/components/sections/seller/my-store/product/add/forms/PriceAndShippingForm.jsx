...
const PriceAndShippingForm = ({
  ...
  useEffect(() => {
    if (selectedCountry) {
      const cities = City.getCitiesOfCountry(selectedCountry)?.map(city => ({
        value: city.name,
        label: city.name
      })) || [];
  ...
  const allCategories = ['electronics', 'lamp', 'furniture', 'clothing', 'books', 'sports'];
      ...
      <div className={cn(
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="grid w-full grid-cols-2 gap-4">
            {pricingFormats.map((format, index) => (
              ...
              >
                  <span className={selectedPricingFormat === format ? "text-moonstone" : "text-battleShipGray"}>
          ...
          <div className="flex flex-col gap-1">
            ...
            />
                  ...
                  <div className="flex flex-col gap-1 col-span-2">
                    <Label text="Shipping" className="text-base text-darkBlue"/>
        <CustomSelect
          ...
          setSelectedOption={setSelectedShippingMethod}
                ...
                <>
                  <div className="flex flex-col gap-1">
                    <Label text="Auction Duration" className="text-base text-darkBlue"/>
                    <CustomSelect
                  ...
                  <div className="flex flex-col gap-1">
                    <Label text="Auction Launch date" className="text-base text-darkBlue"/>
                    <InputField
                      type="datetime-local"
                  ...
                  <div className="flex flex-col gap-1">
                    <Label text="Starting Bid" className="text-base text-darkBlue"/>
                    <InputField
                      type="number"
                      value={startingBid}
                      placeholder="$0.00"
                  ...
                  <div className="flex flex-col gap-1">
                    <Label text="Buy it now (optional)" className="text-base text-darkBlue"/>
                    <InputField
                      type="number"
                      value={buyItNow}
                      placeholder="$0.00"
                  ...
                  <div className="flex flex-col gap-1">
                    <Label text="Minimum offer (optional)" className="text-base text-darkBlue"/>
                    <InputField
                      type="number"
                      value={minimumOffer}
                      placeholder="$0.00"
                  ...
                  <div className="flex flex-col gap-1">
                    <Label text="Auto-accept (optional)" className="text-base text-darkBlue"/>
                    <InputField
                      type="number"
                      value={autoAccept}
                      placeholder="$0.00"
        ...
        <div className={cn(
          ...
          selectedPricingFormat === "Auctions" 
            ...
            : "opacity-0 w-0 -translate-x-full overflow-hidden"
        )}>
          <div className="flex flex-col gap-5">
            <div className="flex flex-col">
              <span className="text-lg font-medium text-[#3D3D5D]">All Categories</span>
              <span className="text-sm text-battleShipGray font-light">Add the shipping details</span>
            </div>
        ...
        <div className={cn(
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col">
              <span className="text-lg font-medium text-delftBlue">Shipping</span>
              <span className="text-sm text-battleShipGray font-light">Add the shipping details</span>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                <Label text="Shipping Method" className="text-base text-darkBlue"/>
                <CustomSelect
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-1">
                  <Label text="Weight(kg)" className="text-base text-darkBlue"/>
                  <InputField type="number" placeholder="0.00 kg" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1">
                    <Label text="Length(in)" className="text-base text-darkBlue"/>
                    <InputField type="number" placeholder="0.00 in" />
                  </div>
                  <div className="flex flex-col gap-1">
                    <Label text="Width(in)" className="text-base text-darkBlue"/>
                    <InputField type="number" placeholder="0.00 in" />
                  </div>
                </div>
                <div className="flex flex-col gap-1">
                  <Label text="Height(in)" className="text-base text-darkBlue"/>
                  <InputField type="number" placeholder="0.00 in" />
                </div>
              </div>

              {/* Expandable Shipping Details - Only show for Standard Shipping */}
              {shippingType === "Standard Shipping: Small to Medium Products" && (
                <div className="flex flex-col gap-4">
                  {/* Domestic Shipping */}
                  <div className="flex flex-col gap-1">
                    <Label text="Domestic Shipping" className="text-base text-darkBlue"/>
                    <CustomSelect
                  ...
                  <button className="flex w-56 py-3 gap-2 rounded-full bg-moonstone px-4  items-center text-sm text-white">
                  ...
                  <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                    <div className="flex flex-col gap-1">
                      <span className="text-base font-medium text-darkBlue">Local pickup</span>
                      <span className="text-sm text-delftBlue">Add local pickup</span>
                      <span className="text-sm text-iconGray">
                        Buyers near you can pick the product from the location of your choice
                      </span>
                    </div>
                    <Switch
                      checked={localPickup}
                  ...
                  <div className="flex flex-col gap-1 border-t border-gray-100 pt-4">
                    <Label text="Handling time" className="text-base font-medium text-darkBlue"/>
                    <CustomSelect
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col">
              <span className="text-lg font-medium text-delftBlue">Location</span>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="z-[20]">
                  <CustomSelect
                    ...
                    selectedOption={selectedCountry ? countryOptions.find(c => c.value === selectedCountry)?.label : ''}
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="z-[10]">
                  <CustomSelect
                    ...
                    selectedOption={selectedCity ? cityOptions.find(c => c.value === selectedCity)?.label : ''}
              ...
              <div className="flex flex-col gap-4 pt-4">
                <div className="flex flex-col gap-2">
                  <Label text="Domestic Returns" className="text-base text-darkBlue"/>
                ...
                <div className="flex flex-col gap-2">
                  <Label text="International Returns" className="text-base text-darkBlue"/>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-battleShipGray">
