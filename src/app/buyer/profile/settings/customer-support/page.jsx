...
const CustomerSupportPage = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-5 px-3">
      <PageHeading>{t("buyer.profile.support.page_title")}</PageHeading>
        ...
        {selected === "whatsapp" && (
          <div className="flex flex-col items-center py-10">
            <p className="mb-2 text-lg font-semibold">
              {t("buyer.profile.support.whatsapp_label")}
            </p>
            <a
            ...
            >
              {t("buyer.profile.support.open_whatsapp")}
            </a>
          </div>
        )}
        {selected === "email" && (
          <div className="flex flex-col items-center py-10">
            <p className="mb-2 text-lg font-semibold">
              {t("buyer.profile.support.email_support")}
            </p>
            <a
